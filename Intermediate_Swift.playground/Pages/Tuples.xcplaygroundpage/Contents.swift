...
*/
/*: ##### _Example 1:_ */
let tuple1 = ("nuts", "figs", 15) // Type => (String, String, Int)
/*:
...
*/
// make it let if you aren't mutating
...
/*: 
 ...
 - Write a for loop to the first 2 elements to 25, and 182 (centementers).
 - If there is a match return the name. 
 - If not return nil.
*/
